...
VERSION_NUMBER = 0.3
GAME_MODE = ["None", "All Pick", "Captain's Mode", "Random Draft", "Single Draft", "All Random", "Intro", "Diretide",
 "Reverse Captain's Mode", "The Greeviling", "Tutorial", "Mid Only", "Least Played", "New Player Pool", "Compendium Matchmaking", "Captain's Draft"]
...
class pyDota2:
	...
	def getHeroesDict(self, language="en_us"):
		...
		heroesDecodedJSON = heroesJSON.read().decode("utf-8")
	...
	def getRaritiesDict(self, language="en_us"):
		...
		raritiesDecodedJSON = raritiesJSON.read().decode("utf-8")
	...
	def getMatchHistoryDictBySequenceNum(self, startAtMatchSeqNum, matchesRequested=25):
		...
		mHistorySNumDecodedJSON = mHistorySNumJSON.read().decode("utf-8")
	...
	def getTeamInfoDictByTeamID(self, startAtTeamID=0, teamRequested=10):
		...
		tTeamIDDecodedJSON = tTeamIDJSON.read().decode("utf-8")
	...
	def getLiveLeagueGamesDict(self):
		...
		lLeagueDecodedJSON = lLeagueJSON.read().decode("utf-8")
	...
	def getLeagueListingDict(self, language="en_us"):
		...
		lListingDecodedJSON = lListingJSON.read().decode("utf-8")
	...
	def getMatchDetailDict(self, matchID):
		...
		mDetailDecodedJSON = mDetailJSON.read().decode("utf-8")
...
if __name__ == "__main__":
	...
	pydota = pyDota2("CA9CA3671A1A2B7DDAF52457F56B9B6D");
	tmpMHistoryDict = pydota.getMatchHistoryDict(matchesRequested=1)
	print(tmpMHistoryDict)
	tmpMDetailDict = pydota.getMatchDetailDict("144634170")
	...
	tmpMDetailSNDict = pydota.getMatchHistoryDictBySequenceNum("50")
